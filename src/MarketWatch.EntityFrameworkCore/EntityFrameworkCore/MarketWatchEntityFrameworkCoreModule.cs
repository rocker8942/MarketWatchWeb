...
{
    [DependsOn(
        typeof(MarketWatchDomainModule),
    ...
    public class MarketWatchEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<MarketWatchDbContext>(options =>
            {
                ...
                options.AddRepository<FundStrategy, FundStrategyRepository>();
            });

            Configure<AbpDbContextOptions>(options =>
            {
                /* The main point to change your DBMS.
                 * See also MarketWatchMigrationsDbContextFactory for EF Core tooling. */
