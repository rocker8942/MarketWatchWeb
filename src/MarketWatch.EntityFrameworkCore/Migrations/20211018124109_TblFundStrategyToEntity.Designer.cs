...
namespace MarketWatch.Migrations
{
    ...
    [Migration("20211018124109_TblFundStrategyToEntity")]
    partial class TblFundStrategyToEntity
    {
            ...
            modelBuilder.Entity("MarketWatch.Simulation.AnalysisDayInvestDayDiff", b =>
                {
                    ...
                    b.ToView("AnalysisDayInvestDayDiff");
                });
            ...
            modelBuilder.Entity("MarketWatch.Simulation.BacktestHistory", b =>
                {
                    ...
                    b.Property<string>("FollowStock")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("followStock");

                    b.Property<decimal>("LeaderChange")
                        .HasColumnType("decimal(18,4)")
                        .HasColumnName("leaderChange");

                    b.Property<string>("MainLeader")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.Property<decimal>("RateOfReturn")
                        .HasColumnType("decimal(18,4)")
            ...
            modelBuilder.Entity("MarketWatch.Simulation.CoefficientPair", b =>
                {
                    ...
                    b.Property<DateTime?>("LeadingBy")
                        .HasColumnType("datetime")
                        .HasColumnName("leading_by");

                    b.HasKey("CodeX", "CodeY", "Leader")
            ...
            modelBuilder.Entity("MarketWatch.Simulation.VwStockToAnalysis", b =>
                {
                    ...
                    b.Property<decimal?>("Tbond")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("TBond");

                    b.ToView("vwStockToAnalysis");
                });
            ...
            modelBuilder.Entity("MarketWatch.Simulation.StockInfo", b =>
                {
                    ...
                    b.Navigation("CoefficientPairCodeYNavigations");

                    b.Navigation("StockPrices");

                    b.Navigation("StockToAnalyses");
                });
